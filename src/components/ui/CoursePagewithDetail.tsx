    ...
    return (
      <>
        ...
        <div className="min-h-screen bg-white">
          <div className="bg-gradient-to-br from-[#1725BB] via-[#0f1a8f] to-[#1725BB] text-white py-16">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="animate-pulse">
                <div className="h-6 bg-blue-400/30 rounded w-32 mb-8"></div>
                <div className="h-8 bg-blue-400/30 rounded w-48 mb-4"></div>
                <div className="h-12 bg-blue-400/30 rounded w-3/4 mb-6"></div>
                <div className="h-6 bg-blue-400/30 rounded w-1/2 mb-10"></div>
                <div className="flex gap-4">
                  <div className="h-10 bg-blue-400/30 rounded w-24"></div>
                  <div className="h-10 bg-blue-400/30 rounded w-24"></div>
                  <div className="h-10 bg-blue-400/30 rounded w-24"></div>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="grid lg:grid-cols-3 gap-12">
              ...
              <div className="lg:col-span-1">
                <div className="sticky top-24 bg-white rounded-2xl shadow-xl border-2 border-gray-100 p-6 animate-pulse">
            ...
            <article className="lg:col-span-2 space-y-6 sm:space-y-8">
              ...
              <section className="bg-gradient-to-br from-[#1725BB]/5 via-[#00D0FF]/5 to-[#9BF900]/5 rounded-xl sm:rounded-2xl border border-[#1725BB]/20 p-4 sm:p-6 md:p-8 shadow-sm">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                  {course.career_opportunities.map((role, idx) => (
                    <div
                      key={idx}
            ...
            <aside className="lg:col-span-1">
              <div className="sticky top-24 bg-white rounded-xl sm:rounded-2xl shadow-xl border-2 border-gray-100 overflow-hidden hover:shadow-2xl transition-shadow">
                ...
                <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
                  ...
                  <AdmissionProvider>
                    <EnrollButton course={course.title} />
                  </AdmissionProvider>
