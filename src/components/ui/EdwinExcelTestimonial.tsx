...
export default function EdwinExcelTestimonial() {
  ...
  { 
    name: 'Priya Menon', 
    role: 'MBA Graduate', 
    text: 'Completed my MBA while working full-time. The flexible online classes and excellent faculty support made it possible. Now I have better career prospects!', 
    rating: 5, 
    image: "PM",
  ...
  { 
    name: 'Rajesh Kumar', 
    role: 'B.Com Graduate', 
    text: 'EdwinExcel gave me a second chance at education. The affordable fees and quality teaching helped me complete my degree. Highly satisfied!', 
    rating: 5, 
    image: "RK",
  },
  { 
    name: 'Anjali Nair', 
    role: 'MCA Student', 
    text: 'The quality of education and continuous support from the team is outstanding. Study materials are excellent and exams are well-structured.', 
    rating: 5, 
   image: "AN",
  },
  { 
    name: 'Muhammed Rafi', 
    role: 'BBA Graduate', 
    text: 'The EdwinExcel program helped me build both academic knowledge and confidence. The mentorship sessions and career guidance were very useful.', 
    rating: 5, 
    image: "MR",
  },
  { 
    name: 'Sneha Krishnan', 
    role: 'M.Com Student', 
    text: 'I’m really happy with the flexibility EdwinExcel provides. The online classes are interactive and the support team responds quickly to queries.', 
    rating: 5, 
   image: "SK",
  },
  { 
    name: 'Akhil Mathew', 
    role: 'BCA Graduate', 
    text: 'The practical approach and well-designed syllabus made learning enjoyable. I could balance my studies and job easily thanks to EdwinExcel.', 
    rating: 5, 
    image: "AM",
  },
  { 
    name: 'Fathima Shirin', 
    role: 'BA English Graduate', 
    text: 'EdwinExcel made higher education accessible from my hometown. The classes were engaging, and I loved the supportive environment.', 
    rating: 5, 
   image: "FS",
  }
];
      ...
      <section className="relative z-10 w-full py-12 sm:py-16 md:py-20 px-4 flex flex-col items-center">
        ...
        >
          ...
          <p className="text-white/80 text-sm sm:text-base max-w-2xl mx-auto px-2">
            At Edwin Excel, we unlock potential through knowledge, empowering
